  ...
  return (
    <div className="min-h-screen bg-obsidian pt-32 text-linen md:pt-40">
      ...
      <div className="px-5 pb-8 md:px-10">
        ...
        <h2 className="font-heading py-3 text-5xl uppercase leading-none md:text-7xl">Clients</h2>
      </div>
      <InfiniteCarousel />
      <PhotosCategories content={getGalleryCategories("clients")} type="clients" />
      <Footer />
    </div>
  );
}
